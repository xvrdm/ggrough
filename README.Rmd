...
Call `get_rough_chart()`, using your ggplot2 chart as the first arguments. See the [options to customize your output](https://xvrdm.github.io/ggrough/articles/Customize%20chart.html).
